...
public class Tools extends Frame{
	...
	static void luanchFrame(Frame f) {
		f.setBounds(600, 120, Application.WIDTH + Application.SIDEBAR*2, Application.HEIGHT + Application.UPBAR + Application.SIDEBAR);
	...
	static void drawClipImg(Image img, Graphics g, int x, int y, int mx, int my, int mw, int mh) {
		...
		g.setClip(Application.SIDEBAR, Application.UPBAR, Application.WIDTH, Application.HEIGHT);//设置回全屏
	}
}
